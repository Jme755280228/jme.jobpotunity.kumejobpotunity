...
import jme.jobpotunity.kumejobpotunity.domain.enums.ApplicationStatus; // <-- import path အသစ်
import jme.jobpotunity.kumejobpotunity.domain.job.JobPosting;      // <-- import path အသစ်
import jme.jobpotunity.kumejobpotunity.domain.user.ApplicantProfile; // <-- import path အသစ်
